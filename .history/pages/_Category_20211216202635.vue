<template>
  <main class="subpage">
    ...
    <button class="back-btn hover:bg-gray-800" @click="handleBack"><span class="arrow-up"><img class="arrow-up-img" src="../assets/img/pfeil_w.svg"></span>Zurück zur Startseite</button>
  </main>
</template>
